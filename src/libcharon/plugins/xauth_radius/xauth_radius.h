...
/**
 * @defgroup xauth_radius_i xauth_radius
 * @{ @ingroup xauth_radius
 */

#ifndef XAUTH_RADIUS_H_
#define XAUTH_RADIUS_H_

typedef struct xauth_radius_t xauth_radius_t;
